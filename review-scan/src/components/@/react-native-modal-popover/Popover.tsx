/*
 * @Fork: https://github.com/doomsower/react-native-modal-popover/blob/v2.1.3/src/Popover.tsx
 * @Author: czy0729
...
import {
  ...
  Rect,
  Size
} from 'react-native-modal-popover/lib/PopoverGeometry'
...
export class Popover extends React.PureComponent<PopoverProps, PopoverState> {
  ...
  private onOrientationChange = () => {
    ...
    this.defaultDisplayArea = {
      ...
      height:
        dimensions.height - 20 - (this.props.calculateStatusBar ? StatusBar.currentHeight ?? 0 : 0)
    }
  }
  ...
  private computeStyles = () => {
    ...
    return {
      ...
      popover: [styles.popover, this.props.popoverStyle, { top: origin.y, left: origin.x }],
      content: [
        styles.content,
