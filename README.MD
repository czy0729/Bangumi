...
安卓 [(APK下载)](https://github.com/czy0729/Bangumi/releases) | [(酷安下载)](https://www.coolapk.com/apk/235642)

苹果还没过审, 有方法可以试用 [(iOS试用方法)](https://github.com/czy0729/Bangumi/blob/master/IOS-TEST.MD)
...
- [ ] [登陆] 改变跳转到登陆页面的之前的按钮的布局 (应付 iOS 审核)
- [ ] [帖子] 部分小组需要加入了才能回复
- [ ] [帖子] 关闭主题应不能回复
