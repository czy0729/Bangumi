...
- [x] [设置] 翻译引擎支持 gemini
- [x] [条目] 优化音乐查找 MV 的结果排序

### 修复

- [x] [空间] 修复了点击浏览器打开后崩溃的问题
- [x] 尝试修复有用户遇到一直跳版本更新提示

## 8.25.0 - 2025/10/01

### 优化

- [x] [每日放送] 更新 2025S4 元数据

### 修复

- [x] [条目] 修复评论出现 HTML 实体编码
- [x] [空间] 修复了历史帖子多次加载后会出现重复的问题
- [x] [设置] 修复自定义百度翻译账号没有保存的问题

[当前版本图文说明](https://www.yuque.com/chenzhenyu-k0epm/znygb4/reiyz4q2uk7kity7?singleDoc)
