 ...
 * @Last Modified time: 2019-11-23 22:49:43
 */
...
class TinygrailTree extends React.Component {
  ...
  onAlert = () => {
    Alert.alert(
      '小圣杯助手',
      '0. 长按方格展开功能菜单.\n 1. 本功能处于实验性阶段, 不保证能正常渲染, 不正常请尝试刷新或者在讨论组等联系作者. \n 2. 计算的数据只供参考, 不排除会出现不准确丢失的情况. \n 3. 因角色数量可能导致流量变大, 页面当有缓存数据不会自动刷新, 请点击旁边的按钮刷新. \n 4. 部分数据可能毫无意义, 只是顺便调出来, 还请自己把握(bgm38).',
      [
        {
          text: '确定'
        }
