 ...
 * @Last Modified time: 2019-04-07 03:31:37
 */
import React from 'react'
import { StyleSheet, View } from 'react-native'
import PropTypes from 'prop-types'
import { observer } from 'mobx-react'
import { Flex, Activity, Button, Icon, Text, Touchable } from '@components'
...
const Box = ({ style }, { $ }) => {
  ...
  return (
    <View style={[_.container.wind, style]}>
      ...
      {loading && $.isLogin ? (
        <Flex style={[styles.height, _.mt.md]} justify='center'>
          <Activity />
        </Flex>
      ) : (
        <View style={[styles.height, shadow, _.mt.md]}>
