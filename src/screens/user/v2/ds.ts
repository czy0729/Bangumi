 ...
 * @Last Modified time: 2023-12-31 12:52:38
 */
import Constants from 'expo-constants'
import { _ } from '@stores'
import { COLLECTION_STATUS, MODEL_COLLECTIONS_ORDERBY, MODEL_SUBJECT_TYPE } from '@constants'
...
/** fixed 后带背景的头部高度 */
export const H_HEADER = _.platforms(88, 68, 80, 80 - Constants.statusBarHeight) + H_RADIUS_LINE
