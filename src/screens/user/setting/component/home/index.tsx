 ...
 * @Last Modified time: 2024-01-11 04:39:01
 */
import React from 'react'
import { ActionSheet, Heatmap, SegmentedControl, SwitchPro, Text } from '@components'
...
import { SettingHomeGridCoverLayout, SettingHomeLayout, SettingHomeSorting } from '@types'
import styles from '../../styles'
import { getShows, getYuqueThumbs } from '../../utils'
import CustomBtn from './custom-btn'
import { COMPONENT, HOME_COUNT_VIEW, HOME_SORTING_INFORMATION, TEXTS, VALUES } from './ds'
  ...
  return useObserver(() => {
    ...
    return (
      <>
        ...
        <ActionSheet show={state} title='进度' height={filter ? 400 : 760} onClose={setFalse}>
          {/* 布局 */}
          <ItemSettingBlock
            ...
            ft={
              <SegmentedControl
                ...
                onValueChange={label => {
                  ...
                  const _value = label === VALUES[0] ? true : label === VALUES[1] ? false : -1
