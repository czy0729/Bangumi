 ...
 * @Last Modified time: 2024-01-11 04:31:25
 */
import React, { useCallback } from 'react'
import { View } from 'react-native'
import { ActionSheet, Heatmap, Katakana as KText, Text } from '@components'
  ...
  return useObserver(() => {
    ...
    return (
      <>
        ...
        <ActionSheet show={state} title='其他' height={filter ? 400 : 640} onClose={setFalse}>
          {/* 自定义源头 */}
          <ItemSetting
            arrow
            highlight
