 ...
 * @Last Modified time: 2024-01-11 04:47:41
 */
...
import { Avatar, Cover, ItemSetting, ItemSettingBlock } from '@_'
...
import { COMPONENT, height, TEXTS, URL_BOOK, URL_GAME, URL_MUSIC, width } from './ds'
          ...
          <ItemSetting
            ...
            ft={
              <SegmentedControl
                ...
                selectedIndex={SETTING_TRANSITION.findIndex(item => item.value === transition)}
                onValueChange={label => {
                  if (label) {
                    t('设置.切换', {
                      title: '切页动画',
