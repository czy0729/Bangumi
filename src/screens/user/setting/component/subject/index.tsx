 ...
 * @Last Modified time: 2024-01-11 04:41:08
 */
import React from 'react'
import { ActionSheet, Heatmap, Highlight, SegmentedControl, Text } from '@components'
...
import { COMPONENT, DATA, TEXTS, THUMBS, VALUES, VALUES_2 } from './ds'
  ...
  return useObserver(() => {
    ...
    return (
      <>
        ...
        <ActionSheet show={state} title='条目' height={filter ? 400 : 760} onClose={setFalse}>
          {/* 其他用户收藏数量 */}
          <ItemSetting
