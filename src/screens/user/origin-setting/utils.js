 ...
 * @Last Modified time: 2022-03-23 17:39:11
 */
    ...
    music: [
      {
        id: 'music|163',
        name: '网易云',
        url: 'https://www.baidu.com/s?word=site%3Amusic.163.com+%E4%B8%93%E8%BE%91+[CN]',
        sort: 0,
        active: 1
      },
      {
        id: 'music|qq',
        name: 'QQ音乐',
        url: 'https://www.baidu.com/s?word=site%3Ay.qq.com+%E4%B8%93%E8%BE%91+[CN]',
        sort: 0,
        active: 1
      },
      {
        id: 'music|bilibili',
        name: 'bilibili',
        url: 'https://search.bilibili.com/all?keyword=[CN]&from_source=nav_suggest_new&order=stow&duration=0&tids_1=3',
        sort: 0,
        active: 1
      }
    ],
 ...
 * 获取设置数据
 */
export function getOriginConfig(userOriginSetting = {}) {
 ...
 * 获取类型Popover实际使用数据
 */
// export function getTypeOriginData({
//   type,
//   cn,
//   jp,
//   userOriginConfig,
