...
function Media() {
  ...
  const elMatchLink = useMemo(
    ...
    [handleSwitchMatchLink, matchLink]
  )
  ...
  const elAcSearchV2 = useMemo(
    ...
    [acSearchV2, handleSwitchAcSearch]
  )
  ...
  const elAcSearchPopable = useMemo(
    ...
    [acSearchPopable, acSearchV2, handleSwitchAcSearchPopable]
  )

  /** 试一试 */
  const elTryAcSearchPopable = useMemo(
    () => (
