 ...
 * @Last Modified time: 2023-06-13 05:51:36
 */
import React from 'react'
import { View } from 'react-native'
import { ActionSheet, Flex, Text, SwitchPro, Divider } from '@components'
...
function Setting({ length }) {
  ...
  return useObserver(() => {
    ...
    return (
      <>
        <IconTouchable name='md-menu' color={_.colorDesc} onPress={setTrue} />
