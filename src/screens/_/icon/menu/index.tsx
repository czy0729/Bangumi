 ...
 * @Last Modified time: 2026-03-19 21:53:45
 */
...
import { COMPONENT, IMAGE_CONFIG } from './ds'
import { memoStyles } from './styles'

import type { Props as IconMenuProps } from './types'
export type { IconMenuProps }

export const IconMenu = observer(({ id, icon, text, size, wrap = true }: IconMenuProps) => {
  r(COMPONENT)
  ...
  const renderContent = () => {
    ...
    if (Array.isArray(icon)) {
      return (
        <>
          <Iconfont name={icon[0]} size={iconSize} color={wrap ? _.__colorPlain__ : _.colorTitle} />
