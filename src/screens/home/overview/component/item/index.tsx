...
import { getTypeCn } from '@components/horizontal-list/item/utils'
import { InView } from '@_'
import { _ } from '@stores'
import { getCoverLarge, x18 } from '@utils'
    ...
    >
      <Flex justify='center'>
        <InView y={(height + styles.item.marginBottom + descSize + titleSize) * index + 1}>
          <Cover src={image} width={width} height={height} cdn={!x18(subjectId)} />
        </InView>
      </Flex>
