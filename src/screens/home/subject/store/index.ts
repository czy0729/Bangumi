 ...
 * @Last Modified time: 2026-05-25 06:14:36
 */
  ...
  onHeaderRefresh = async () => {
    ...
    await queue(
      [
        ...
        () =>
          this.withFocus(() => this.fetchSnapshot(), 'fetchSnapshot', !this.hasExternalScreenshots)
      ],
      1
    )
    ...
    queue(
      [
        ...
        () => this.withFocus(() => this.fetchFriendsRating(), 'fetchFriendsRating'),
