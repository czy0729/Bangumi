...
const HOST_STATIC = `${HOST_CDN_STATIC}/Bangumi-Static` as const

/** 发现首页 */
export const CDN_DISCOVERY_HOME = () => {
  return `${HOST_STATIC}/data/discovery/home.json` as const
}

/** 找番剧数据 */
export const CDN_STATIC_ANIME = () => {
  return `${HOST_STATIC}/data/agefans/anime.min.json` as const
}

/** 找文库数据 */
export const CDN_STATIC_WENKU = () => {
  return `${HOST_STATIC}/data/wenku8/wenku.min.json` as const
}

/** 找漫画数据 */
export const CDN_STATIC_MANGA = () => {
  return `${HOST_STATIC}/data/manhuadb/manga.min.json` as const
}

/** 找 Hentai 数据 */
export const CDN_STATIC_HENTAI = () => {
  return `${HOST_STATIC}/data/h/hentai.min.json` as const
}
