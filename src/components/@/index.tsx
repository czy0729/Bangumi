...
export { RNDraggableGrid } from './react-native-draggable-grid'
...
export { default as Material } from './vector-icons/MaterialIcons'
export {
  AppIcons,
  IoniconsIcons,
  MaterialIcons
} from './vector-icons/vendor/react-native-vector-icons/glyphmaps'
