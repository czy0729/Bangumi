...
import TransitionConfigs from 'react-navigation-stack/src/views/StackView/StackViewTransitionConfigs'
import HeaderStyleInterpolator from 'react-navigation-stack/src/views/Header/HeaderStyleInterpolator'
import StackGestureContext from 'react-navigation-stack/src/utils/StackGestureContext'
import clamp from 'react-navigation-stack/src/utils/clamp'
import { supportsImprovedSpringAnimation } from 'react-navigation-stack/src/utils/ReactNativeFeatures'
...
class StackViewLayout extends React.Component {
  ...
  _renderHeader(scene, headerMode) {
    ...
    const backgroundTransitionPresetInterpolator =
      this._getHeaderBackgroundTransitionPreset()
  ...
  _isGestureEnabled() {
    const gesturesEnabled =
      this.props.transitionProps.scene.descriptor.options.gesturesEnabled
  ...
  _getHeaderBackgroundTransitionPreset() {
    ...
    if (headerBackgroundTransitionPreset) {
      if (
        HEADER_BACKGROUND_TRANSITION_PRESET.includes(headerBackgroundTransitionPreset)
      ) {
